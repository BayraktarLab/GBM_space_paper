...
# Optional but required if using GPU with tensorly
...
CCI_comparisons_GBM = {
 ...
 'sp_batchAT5': {'Non-proliferative 1': ['AC progenitor-like 2'],
  ...
  'Gliosis': ['AC-gliosis-like 1',
   ...
   'Hypoxic 2',
   'Hypoxic 1']},
 'sp_batchAT15': {'Non-proliferative 1': ['AC progenitor-like 2',
   'AC progenitor-like 4'],
  'Proliferative': ['OPC-like 3',
   ...
   'AC-gliosis-like 1',
   'Hypoxic 2'],
  'Gliosis': ['Gliosis-like', 'AC-gliosis-like 1', 'Hypoxic 1']}}


analysis_name = "c2c"
donor_id_list = ['AT4', 'AT5',  'AT6', 'AT10', 'AT12','AT14', 'AT15']

tme_ligand_niches = ["Gliosis"]
gbm_receptor_niches = ["Gliosis"]
...
print(ligand_cell_states)
print(rec_cell_states)
...
factors, axes = c2c.plotting.tensor_factors_plot(interaction_tensor=tensor,
                                                 ...
                                                 fontsize=10,
                                                 filename = os.path.join("../../data/out_data/sc_ccc", analysis_name, f"Tensor-Factorization_by_{sample_key}_{str_lg}-VS-{str_rec}.pdf")
                                                 )

factors = c2c.io.load_tensor_factors(os.path.join("../../data/out_data/sc_ccc", analysis_name, f'Loadings_by_{sample_key}_{str_lg}-VS-{str_rec}.xlsx'))
